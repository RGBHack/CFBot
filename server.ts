...
const helpEmbed = new discord.MessageEmbed()
  .setColor('#0099ff')
  .setTitle('CFBot Help')
  .setAuthor('CFBot Help', 'https://i.imgur.com/wSTFkRM.png', 'https://discord.js.org')
...
bot.on('message', (msg) => {
  ...
  // get contestID and return standings, problems, etc.
      ...
      codeforces.contest.standings({ contestId: parseInt(msg.content.substr(12, msg.content.length))}, (err, data) => {
        if(err){
          console.log(err)
        ...
        var send_str = ""
        send_str += `There are ${data.problems.length} Problems in contest #${msg.content.substr(12, msg.content.length)}:\n`
